...
Note:
1. You should call `ghget` or `ghset` whenever the `library` was called.
2. To reset the permanent storing use `ghset('key', ''). The downloaded files will not be deleted.
